...
const antiSpam = new AntiSpam({
        ...
        banMessage: '**{user_tag}** Has been banned spamming.', // Message that will be sent in chat upon banning a user.
    ...
    client.on('ready', () => client.user.setActivity(`Spam = Mute`));
...
//------------------------------------------------------------------------------------------\\
//------------------------------------------------------------------------------------------\\
    client.login('ODIwOTUwODExNTE2OTkzNTQ3.YE8oBQ.Ly_Ss-ipgfQvml-J3UL5wMy16ZY'); //Developer By iBPlus
//------------------------------------------------------------------------------------------\\
//------------------------------------------------------------------------------------------\\
//------------------------------------------------------------------------------------------\\
//------------------------------------------------------------------------------------------\\
